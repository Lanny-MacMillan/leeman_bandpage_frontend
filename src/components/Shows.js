            ...
            return(
                ...
                <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary" component="p">
                        ...
                        {show.description}
                        <br/>
                        <Button id='Button' variant="contained" onClick={() => {showPage(show)}} className="btn btn-link" role="button">Click for more info</Button>
